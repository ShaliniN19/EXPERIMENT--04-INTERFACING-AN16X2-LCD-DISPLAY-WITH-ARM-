...

{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  // D4, D5, D6, D7 Pins (based on your schematic wiring)
  ...
  Lcd_string(&lcd,"Name:");
  HAL_Delay(500);
  Lcd_string(&lcd,"ABCDEFGH");
  HAL_Delay(1000);
  Lcd_cursor(&lcd,1,1);
  Lcd_string(&lcd,"Reg. No:");
  HAL_Delay(500);
  Lcd_string(&lcd,"1234567");
  HAL_Delay(500);
    /* Infinite loop */
...
## Output screen shots of proteus  :
 ![WhatsApp Image 2025-10-25 at 20 22 54_2c234144](https://github.com/user-attachments/assets/3d053f7b-42eb-4ec4-818a-19cf581cbd86)
